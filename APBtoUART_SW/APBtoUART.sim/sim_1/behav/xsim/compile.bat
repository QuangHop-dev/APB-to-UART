...
REM
REM Generated by Vivado on Sun Aug 17 00:28:04 +0700 2025
...
echo "xvlog --incr --relax -prj ReceivedatanoParity_vlog.prj"
call xvlog  --incr --relax -prj ReceivedatanoParity_vlog.prj -log xvlog.log
